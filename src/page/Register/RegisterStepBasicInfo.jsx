...
function RegisterStepBasicInfo({ userFormRef, storeFormRef, onSubmitUserSuccess, onSubmitStoreSuccess }) {
  ...
  const onSubmitStore = handleSubmitStore((data) => {
    Object.entries(data).forEach(([key, value]) => {
      handleStoreChange({
        target: { name: String(key), value: String(value) },
      });
    });
                ...
                >
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-9">
                      ...
                      />
                      <div className="error-message text-danger mt-1">
                        {userErrors.user_password
                          ? userErrors.user_password.message
                          : "　"}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-9">
                      ...
                      >
                        <option defaultValue value="請選擇性別">
                          請選擇性別
                        </option>
                      ...
                      <input
                        {...user("user_tel", {
                          pattern: {
                            ...
                            message:
                              "市話格式為02-12345678手機格式為0912456789",
                          },
                        })}
                        type="tel"
                ...
                >
                    ...
                    <div className="col-sm-10">
                      <AddressForm
                        onChange={(fullAddress) =>
                          setValue("store_self_address", fullAddress)
                        }
                      />
                      <input
                      ...
                      />
                      <div className="error-message text-danger mt-1">
                        {storeErrors.store_self_address
                          ? storeErrors.store_self_address.message
                          : "　"}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                      ...
                      />
                      <div className="error-message text-danger mt-1">
                        {storeErrors.store_contact
                          ? storeErrors.store_contact.message
                          : "　"}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-5">
                      ...
                      >
                        <option defaultValue value="請選擇驗證方式">
                          請選擇驗證方式
                        </option>
                        <option value="統一編號">
                          有統一編號，請輸入統一編號
                      ...
                      <div className="error-message text-danger mt-1">
                        {storeErrors.store_method
                          ? storeErrors.store_method.message
                          : "　"}
                      </div>
                    </div>
                    <div className="col-sm-5">
                      ...
                      <div className="error-message text-danger mt-1">
                        {storeErrors.store_tax_id
                          ? storeErrors.store_tax_id.message
                          : "　"}
                        {storeErrors.store_documentation
                          ? storeErrors.store_documentation.message
                          : "　"}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                      ...
                      />
                      <div className="error-message text-danger mt-1">
                        {storeErrors.store_website
                          ? storeErrors.store_website.message
                          : "　"}
                      </div>
                    </div>
                  </div>
